...
/**
 * A common implementation of the {@link BaseStepDialog} that creates many of
 * the common UI components.
 *
 * @param <StepMeta>
 */
public abstract class AbstractStepDialog<StepMeta extends StepMetaInterface> extends BaseStepDialog
	...
	public StepMeta getStepMeta() {
		return (StepMeta) this.baseStepMeta;
	}
	...
	protected void createButtonsForButtonBar(final Composite parent) {
		...
		wCancel.addListener(SWT.Selection, Event -> onCancelPressed());
		...
		wOK.addListener(SWT.Selection, Event -> onOkPressed());
	}
...
// TODO:           ConstUI.LARG_ICON_SIZE, ConstUI.LARGE_ICON_SIZE);
	...
	/**
	 * Copy information from the {@link StepMeta} meta to the dialog fields.
	 */
	protected abstract void loadMeta(final StepMeta stepMeta);
	 ...
	 */
	/**
	 * Creates a new instance of {@link StepMeta} and populates it with provided
	 * data from the dialog.
	 *
	 * @param meta a new instance of {@link StepMeta}
	 */
	protected abstract void saveMeta(final StepMeta stepMeta);
