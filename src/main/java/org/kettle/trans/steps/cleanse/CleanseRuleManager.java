...
public class CleanseRuleManager {
	...
	/**
	 * Create processor instance by rule identifier
	 * 
	 * @param id
	 *            The rule identifier
	 * @return the processor instance or null if not found
	 */
	public ValueProcessor createProcessor(final String id) throws KettlePluginException {

		if (Utils.isEmpty(id)) {
			return null;
		}

		return PluginRegistry.getInstance().loadClass(CleanseRulePluginType.class, id, ValueProcessor.class);
	}
